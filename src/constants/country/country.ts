...
export const COUNTRIES: ICountry[] = [
  ...
  { nameEN: 'Cote D"Ivoire', nameZH: "科特迪瓦", code: "CI" },
  {
    nameEN: "Croatia",
    nameZH: "克罗地亚",
    code: "HR",
  ...
  { nameEN: "Dominican Republic", nameZH: "多明尼加共和国", code: "DO" },
  {
    nameEN: "Ecuador",
    nameZH: "厄瓜多尔",
    code: "EC",
  ...
  { nameEN: "Greenland", nameZH: "格陵兰岛", code: "GL" },
  {
    nameEN: "Grenada",
    nameZH: "格林纳达",
    code: "GD",
  },
  { nameEN: "Guadeloupe", nameZH: "瓜德罗普岛", code: "GP" },
  {
    nameEN: "Guam",
    nameZH: "关岛",
    code: "GU",
  ...
  { nameEN: "Indonesia", nameZH: "印尼", code: "ID" },
  {
  ...
  { nameEN: "Korea, Republic of", nameZH: "大韩民国", code: "KR" },
  {
    nameEN: "Kuwait",
    nameZH: "科威特",
    code: "KW",
  ...
  { nameEN: "United Arab Emirates", nameZH: "阿联酋", code: "AE" },
  {
  ...
  { nameEN: "Vietnam", nameZH: "越南", code: "VN" },
  {
    nameEN: "Virgin Islands, British",
    nameZH: "英属维尔京群岛",
    code: "VG",
  },
  { nameEN: "Virgin Islands, U.S.", nameZH: "维京群岛,美国", code: "VI" },
  {
